...
Target support varies because each AI platform exposes a different native contract. PromptScript preserves one source model while formatters map supported capabilities to target-native output. Use the [target platform matrix](https://getpromptscript.dev/v1.19/features/target-platforms/index.md) to choose versions and capabilities.

## Explore Features

- [Agents](https://getpromptscript.dev/v1.19/features/agents/index.md) - specialized subagents, models, tools, skills, and MCP access
- [Skills and Resources](https://getpromptscript.dev/v1.19/features/skills/index.md) - portable capability packages with references and scripts
- [MCP and Plugins](https://getpromptscript.dev/v1.19/features/integrations/index.md) - tool servers and reusable capability bundles
- [Hooks and Workflows](https://getpromptscript.dev/v1.19/features/automation/index.md) - lifecycle automation and repeatable procedures
- [Target Platforms](https://getpromptscript.dev/v1.19/features/target-platforms/index.md) - 50 built-in targets and output families
...
See [Enterprise Setup](https://getpromptscript.dev/v1.19/guides/enterprise/index.md), [Security](https://getpromptscript.dev/v1.19/guides/security/index.md), and [Policy Engine](https://getpromptscript.dev/v1.19/guides/policy-engine/index.md).
