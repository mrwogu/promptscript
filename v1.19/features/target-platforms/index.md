...
Use the [formatter matrix](https://getpromptscript.dev/v1.19/reference/formatters/index.md) for exact output paths and capability support.
...
- [Supported Formatters](https://getpromptscript.dev/v1.19/reference/formatters/index.md)
- [Configuration: Targets](https://getpromptscript.dev/v1.19/reference/config/#targets)
