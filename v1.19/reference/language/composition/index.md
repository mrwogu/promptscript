...
See [Execution Order](https://getpromptscript.dev/v1.19/reference/language/execution-order/index.md) for operation timing and [Merge and Replacement](https://getpromptscript.dev/v1.19/reference/language/merge-and-replacement/index.md) for modification choices.
