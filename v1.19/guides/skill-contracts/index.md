...
- [Local Skills](https://getpromptscript.dev/v1.19/guides/local-skills/index.md) - Managing skills in your project
- [Parameterized Skills](https://getpromptscript.dev/v1.19/guides/local-skills/#parameterized-skills) - Making skills configurable with `{{var}}` templates
