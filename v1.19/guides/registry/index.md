...
You can also set a default registry via [user-level config](https://getpromptscript.dev/v1.19/guides/user-config/index.md) so `prs init --yes` automatically uses it.

### How Overlay-Aware Suggestions Work

When your registry catalogs Layer 2 / Layer 3 [skill overlays](https://getpromptscript.dev/v1.19/guides/skill-overlays/index.md), `prs init` collapses overlay relationships before showing the picker so you don't see both the base skill and its overlay as separate choices.
...
See [Skill Overlays](https://getpromptscript.dev/v1.19/guides/skill-overlays/index.md) for the overlay model itself, and the [Registry Manifest](#registry-manifest) section below for the full schema.
...
- [Enterprise Setup](https://getpromptscript.dev/v1.19/guides/enterprise/index.md) - Scale PromptScript across your organization
- [CI/CD Integration](https://getpromptscript.dev/v1.19/guides/ci/index.md) - Automate validation and compilation in your pipeline
