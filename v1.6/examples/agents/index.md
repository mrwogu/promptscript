...
- [Language Reference - @agents](https://getpromptscript.dev/v1.6/reference/language/#agents)
- [Skills & Local Example](https://getpromptscript.dev/v1.6/examples/skills-and-local/index.md)
