...
You can also set a default registry via [user-level config](https://getpromptscript.dev/v1.6/guides/user-config/index.md) so `prs init --yes` automatically uses it.
...
- [Enterprise Setup](https://getpromptscript.dev/v1.6/guides/enterprise/index.md) - Scale PromptScript across your organization
- [CI/CD Integration](https://getpromptscript.dev/v1.6/guides/ci/index.md) - Automate validation and compilation in your pipeline
