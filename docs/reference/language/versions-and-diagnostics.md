...
inherited, imported, or inline-composed source declaring `1.5.0` enables
declaration order for the graph even when the entry file declares an older
version. PS018 reports that mixed-version requirement; it does not reject the
composition.
