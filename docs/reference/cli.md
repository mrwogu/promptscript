...
Inside a project that has `@promptscript/cli` in its dependencies, Deno
...
create telemetry events. See [Anonymous Usage Telemetry](telemetry.md).
...
See [Target Platforms](../features/target-platforms.md) for all 50 built-in targets.
