---
title: Migrate Factory Hooks
description: Safely move PromptScript-owned Factory hooks from legacy settings to the canonical hook file
---
...
See [AI Tool Hooks](../guides/hooks.md) for installer behavior and cleanup.
