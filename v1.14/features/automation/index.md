...
- [AI Tool Hooks](https://getpromptscript.dev/v1.14/guides/hooks/index.md)
- [CLI Reference](https://getpromptscript.dev/v1.14/reference/cli/index.md)
- [Configuration: Build Profiles](https://getpromptscript.dev/v1.14/reference/config/#builds)
- [Language Reference: `@hooks`](https://getpromptscript.dev/v1.14/reference/language/#hooks)
- [Language Reference: `@workflows`](https://getpromptscript.dev/v1.14/reference/language/#workflows)
