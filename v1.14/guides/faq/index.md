...
PromptScript currently compiles to **48 AI coding agent targets**. See the full list in [Target Platforms](https://getpromptscript.dev/v1.14/features/target-platforms/index.md) or the [formatter matrix](https://getpromptscript.dev/v1.14/reference/formatters/index.md).
...
See the [Getting Started guide](https://getpromptscript.dev/v1.14/getting-started/index.md) for details.
...
Sources can be local files (`./base`) or registry packages (`@company/standards`). See the [Inheritance guide](https://getpromptscript.dev/v1.14/guides/inheritance/index.md).
...
See the [Registry guide](https://getpromptscript.dev/v1.14/guides/registry/index.md) for full setup instructions.
...
See the [CI/CD guide](https://getpromptscript.dev/v1.14/guides/ci/index.md).
...
The parser encountered invalid syntax, such as an unknown directive or misplaced token. Check the reported location and compare it with the [Language Reference](https://getpromptscript.dev/v1.14/reference/language/index.md).
