...
- [Language Reference - @agents](https://getpromptscript.dev/v1.9/reference/language/#agents)
- [Skills & Local Example](https://getpromptscript.dev/v1.9/examples/skills-and-local/index.md)
