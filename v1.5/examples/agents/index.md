...
- [Language Reference - @agents](https://getpromptscript.dev/v1.5/reference/language/#agents)
- [Skills & Local Example](https://getpromptscript.dev/v1.5/examples/skills-and-local/index.md)
