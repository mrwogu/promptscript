...
For detailed guidelines on AI-assisted migration, including content mapping patterns and common pitfalls, see [AI Migration Best Practices](https://getpromptscript.dev/v1.5/guides/ai-migration-best-practices/index.md).

## Next Steps

After migration:

1. [Set up inheritance](https://getpromptscript.dev/v1.5/guides/inheritance/index.md) if you have multiple projects
1. [Organize multi-file setup](https://getpromptscript.dev/v1.5/guides/multi-file/index.md) for complex projects
1. [Configure CI/CD](https://getpromptscript.dev/v1.5/guides/enterprise/#cicd-integration) for validation
