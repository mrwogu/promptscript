...
Ready to switch? See the [Migration Guide](https://getpromptscript.dev/v1.5/guides/migration/index.md) to convert existing configs, or start fresh with the [Getting Started guide](https://getpromptscript.dev/v1.5/getting-started/index.md).
