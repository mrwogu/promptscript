...
- [Language Reference - @agents](https://getpromptscript.dev/v1.7/reference/language/#agents)
- [Skills & Local Example](https://getpromptscript.dev/v1.7/examples/skills-and-local/index.md)
