...
- [AI Tool Hooks](https://getpromptscript.dev/v1.15/guides/hooks/index.md)
- [CLI Reference](https://getpromptscript.dev/v1.15/reference/cli/index.md)
- [Configuration: Build Profiles](https://getpromptscript.dev/v1.15/reference/config/#builds)
- [Language Reference: `@hooks`](https://getpromptscript.dev/v1.15/reference/language/#hooks)
- [Language Reference: `@workflows`](https://getpromptscript.dev/v1.15/reference/language/#workflows)
