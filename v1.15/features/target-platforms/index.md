...
Use the [formatter matrix](https://getpromptscript.dev/v1.15/reference/formatters/index.md) for exact output paths and capability support.
...
- [Configuration: Targets](https://getpromptscript.dev/v1.15/reference/config/#targets)
...
- [MCP Servers and Plugins](https://getpromptscript.dev/v1.15/features/integrations/index.md)
