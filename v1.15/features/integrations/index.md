...
Target formatters translate these properties into native MCP configuration. File paths and supported fields vary by platform. See the [formatter capability matrix](https://getpromptscript.dev/v1.15/reference/formatters/#mcp-hooks-plugins-support).
...
- [Agents](https://getpromptscript.dev/v1.15/features/agents/index.md)
- [Hooks and Workflows](https://getpromptscript.dev/v1.15/features/automation/index.md)
- [Language Reference: `@mcpServers`](https://getpromptscript.dev/v1.15/reference/language/#mcpservers)
- [Language Reference: `@plugins`](https://getpromptscript.dev/v1.15/reference/language/#plugins)
- [Configuration Reference](https://getpromptscript.dev/v1.15/reference/config/#mcp-hooks-plugins-support)
