...
Low-level hook handler invoked by AI tool hook systems. Not intended for direct use — configure it via [`prs hooks install`](https://getpromptscript.dev/v1.15/reference/cli/hooks/index.md).
...
- [`prs hooks install`](https://getpromptscript.dev/v1.15/reference/cli/hooks/index.md) — scaffold hook configs automatically
- [Hooks Guide](https://getpromptscript.dev/v1.15/guides/hooks/index.md) — end-to-end setup and troubleshooting
