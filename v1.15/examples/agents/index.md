...
- [Agent Platform - Agents](https://getpromptscript.dev/v1.15/features/agents/index.md)
- [Skills & Local Example](https://getpromptscript.dev/v1.15/examples/skills-and-local/index.md)
