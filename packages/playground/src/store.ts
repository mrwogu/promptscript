...
export const selectOutputsForFormatter = (
  ...
  const formatterPatterns: Record<FormatterName, RegExp[]> = {
    ...
    cursor: [/\.cursor\/rules\/.*\.mdc$/, /\.cursorrules$/, /\.cursor\/hooks\.json$/],
    ...
    codex: [/^AGENTS\.md$/, /^\.agents\/skills\/.*\.md$/, /^\.codex\/hooks\.json$/],
    ...
    jules: [/^AGENTS\.md$/],
    devin: [/^AGENTS\.md$/],
    grok: [/^AGENTS\.md$/, /^CLAUDE\.md$/, /\.claude\//, /^\.grok\/hooks\/promptscript\.json$/],
    kimi: [/^AGENTS\.md$/],
    mimo: [/^AGENTS\.md$/],
