...
export const PARITY_MATRIX: SectionSpec[] = [
  {
    ...
    requiredBy: ['github', 'cursor', 'claude', 'antigravity', 'factory', 'opencode', 'gemini'],
    optionalFor: [],
  ...
  },
  {
    ...
    optionalFor: ['cursor', 'claude', 'opencode', 'gemini'],
  ...
  },
  {
    ...
    optionalFor: ['cursor', 'claude', 'factory', 'opencode', 'gemini'],
  ...
  },
  {
    ...
    optionalFor: ['claude', 'opencode', 'gemini'],
