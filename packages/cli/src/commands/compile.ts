 ...
 * Matches HTML comment format (<!-- PromptScript TIMESTAMP - do not edit -->)
 * and YAML comment format (# promptscript-generated: TIMESTAMP).
 * Captures trailing newlines for clean removal.
 */
