...
/**
 * Marker comment that identifies files generated by PromptScript.
 * We check the first 10 lines of a file for this marker.
 */
...
/**
 * Check if a file was generated by PromptScript by looking for the marker in the first 10 lines.
 */
...
async function writeOutputs(
  ...
  for (const output of outputs.values()) {
    ...
    if (isGenerated) {
      // PromptScript-generated files can be overwritten silently
      await mkdir(dirname(outputPath), { recursive: true });
      await writeFile(outputPath, output.content, 'utf-8');
      ConsoleOutput.success(outputPath);
      result.written.push(outputPath);
