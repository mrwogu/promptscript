...
export const MIGRATE_SKILL_CLAUDE = `---
...
export const MIGRATE_SKILL_CURSOR = `# Migrate to PromptScript
...
export const MIGRATE_SKILL_ANTIGRAVITY = `# Migrate to PromptScript
