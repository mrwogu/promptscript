...
See the [Examples guide](https://getpromptscript.dev/v1.13/guides/examples/index.md) for a full walkthrough.
...
These come from the resolver, not the validator (`PS0XX` rules). They appear during `prs compile`, not `prs validate`. See the [Skill Overlays Guide](https://getpromptscript.dev/v1.13/guides/skill-overlays/index.md) for examples and remediation.
...
See [Registry Aliases](https://getpromptscript.dev/v1.13/guides/registry/#registry-aliases) for alias configuration.
