...
- [Agent Platform - Agents](https://getpromptscript.dev/v1.18/features/agents/index.md)
- [Skills & Local Example](https://getpromptscript.dev/v1.18/examples/skills-and-local/index.md)
