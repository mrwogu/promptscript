...
| Task                            | Example                                                                                              |
| ------------------------------- | ---------------------------------------------------------------------------------------------------- |
| Predict composition results     | [Composition and Order](https://getpromptscript.dev/v1.18/examples/composition-and-order/index.md)   |
| Choose merge or replacement     | [Merge vs Replace](https://getpromptscript.dev/v1.18/examples/merge-vs-replace/index.md)             |
| Fix PS038 shape warnings        | [Fix Block Shape Warnings](https://getpromptscript.dev/v1.18/examples/fix-block-shapes/index.md)     |
| Customize generated titles      | [Custom Section Headers](https://getpromptscript.dev/v1.18/examples/custom-section-headers/index.md) |
| Build portable lifecycle policy | [Portable Hooks](https://getpromptscript.dev/v1.18/examples/portable-hooks/index.md)                 |
...
For new syntax 1.6 projects, prefer `@override` when replacing a complete existing target. See [Merge vs Replace](https://getpromptscript.dev/v1.18/examples/merge-vs-replace/index.md).
...
- [Agent Platform](https://getpromptscript.dev/v1.18/features/index.md)
- [Agents](https://getpromptscript.dev/v1.18/features/agents/index.md)
- [Skills and Resources](https://getpromptscript.dev/v1.18/features/skills/index.md)
- [MCP Servers and Plugins](https://getpromptscript.dev/v1.18/features/integrations/index.md)
- [Hooks and Workflows](https://getpromptscript.dev/v1.18/features/automation/index.md)
- [Configuration Reference](https://getpromptscript.dev/v1.18/reference/config/#builds)
