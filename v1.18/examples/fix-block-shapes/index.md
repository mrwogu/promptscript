...
See [Values and Block Bodies](https://getpromptscript.dev/v1.18/reference/language/values-and-block-bodies/index.md) and [Block Shapes](https://getpromptscript.dev/v1.18/reference/block-shapes/index.md).
