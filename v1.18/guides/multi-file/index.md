...
See [Composition and Precedence](https://getpromptscript.dev/v1.18/reference/language/composition/index.md) for the normative matrix and resolved declaration-order examples.
...
- [Local Skills](https://getpromptscript.dev/v1.18/guides/local-skills/index.md) - Install third-party skills with resource files
- [Inheritance Guide](https://getpromptscript.dev/v1.18/guides/inheritance/index.md) - Deep dive into inheritance patterns
- [Enterprise Setup](https://getpromptscript.dev/v1.18/guides/enterprise/index.md) - Organization-wide registries
- [Configuration Reference](https://getpromptscript.dev/v1.18/reference/config/index.md) - Full config options
