...
- A project that completed [Getting Started](https://getpromptscript.dev/v1.18/getting-started/index.md)
...
See [Agent Platform](https://getpromptscript.dev/v1.18/features/index.md) for MCP servers, plugins, and target-specific capabilities.
...
- [Language Reference](https://getpromptscript.dev/v1.18/reference/language/index.md) - Full syntax documentation
- [Agent Platform](https://getpromptscript.dev/v1.18/features/index.md) - Agents, skills, integrations, and automation
- [Inheritance Guide](https://getpromptscript.dev/v1.18/guides/inheritance/index.md) - Advanced inheritance patterns
- [Enterprise Setup](https://getpromptscript.dev/v1.18/guides/enterprise/index.md) - Organization-wide deployment
- [CLI Reference](https://getpromptscript.dev/v1.18/reference/cli/index.md) - All available commands
