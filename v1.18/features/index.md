...
The compiler translates that source into native files for 49 built-in targets. Each target receives the formats and capabilities it supports, such as instruction files, native skills, custom agents, MCP configuration, lifecycle hooks, workflows, and plugins.
...
Target support varies because each AI platform exposes a different native contract. PromptScript preserves one source model while formatters map supported capabilities to target-native output. Use the [target platform matrix](https://getpromptscript.dev/v1.18/features/target-platforms/index.md) to choose versions and capabilities.

## Explore Features

- [Agents](https://getpromptscript.dev/v1.18/features/agents/index.md) - specialized subagents, models, tools, skills, and MCP access
- [Skills and Resources](https://getpromptscript.dev/v1.18/features/skills/index.md) - portable capability packages with references and scripts
- [MCP and Plugins](https://getpromptscript.dev/v1.18/features/integrations/index.md) - tool servers and reusable capability bundles
- [Hooks and Workflows](https://getpromptscript.dev/v1.18/features/automation/index.md) - lifecycle automation and repeatable procedures
- [Target Platforms](https://getpromptscript.dev/v1.18/features/target-platforms/index.md) - 49 built-in targets and output families
...
See [Enterprise Setup](https://getpromptscript.dev/v1.18/guides/enterprise/index.md), [Security](https://getpromptscript.dev/v1.18/guides/security/index.md), and [Policy Engine](https://getpromptscript.dev/v1.18/guides/policy-engine/index.md).
