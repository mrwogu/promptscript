...
- Add more detailed [standards](https://getpromptscript.dev/dev/reference/language/#standards)
- Add [restrictions](https://getpromptscript.dev/dev/reference/language/#restrictions) for safety
- Consider [team setup](https://getpromptscript.dev/dev/examples/team-setup/index.md) for multiple projects
