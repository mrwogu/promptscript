...
- [Local Skills](https://getpromptscript.dev/dev/guides/local-skills/index.md) - Managing skills in your project
- [Parameterized Skills](https://getpromptscript.dev/dev/guides/local-skills/#parameterized-skills) - Making skills configurable with `{{var}}` templates
