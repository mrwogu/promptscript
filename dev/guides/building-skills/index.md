...
See [Skill Contracts](https://getpromptscript.dev/dev/guides/skill-contracts/index.md) for the full reference.
...
See [Markdown Imports](https://getpromptscript.dev/dev/guides/markdown-imports/index.md) for syntax details, version pinning, and the `prs skills` management commands.
...
See [Build Your Registry](https://getpromptscript.dev/dev/guides/registry/index.md) for details.
...
- [Skill Composition](https://getpromptscript.dev/dev/guides/skill-composition/index.md) - Compose complex skills from multiple sub-skill phases
- [Markdown Imports](https://getpromptscript.dev/dev/guides/markdown-imports/index.md) - Import skills directly via `@use` without external tools
- [Using npx skills](https://getpromptscript.dev/dev/guides/npx-skills/index.md) - Install open-source skills from GitHub
- [Local Skills](https://getpromptscript.dev/dev/guides/local-skills/index.md) - Full reference for skill resolution and resource handling
- [Skill Contracts](https://getpromptscript.dev/dev/guides/skill-contracts/index.md) - Define inputs and outputs
- [Shared Resources](https://getpromptscript.dev/dev/guides/shared-resources/index.md) - Share files across all skills
