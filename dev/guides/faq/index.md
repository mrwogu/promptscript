...
PromptScript currently compiles to **50 AI coding agent targets**. See the full list in [Target Platforms](https://getpromptscript.dev/dev/features/target-platforms/index.md) or the [formatter matrix](https://getpromptscript.dev/dev/reference/formatters/index.md).
...
See the [Getting Started guide](https://getpromptscript.dev/dev/getting-started/index.md) for details.
...
Sources can be local files (`./base`) or registry packages (`@company/standards`). See the [Inheritance guide](https://getpromptscript.dev/dev/guides/inheritance/index.md).
...
See the [Registry guide](https://getpromptscript.dev/dev/guides/registry/index.md) for full setup instructions.
