...
- [Building Skills](https://getpromptscript.dev/dev/guides/building-skills/index.md) — skill basics, parameters, and resource files
- [Skill Contracts](https://getpromptscript.dev/dev/guides/skill-contracts/index.md) — define inputs and outputs for phases
- [Inheritance](https://getpromptscript.dev/dev/guides/inheritance/index.md) — single inheritance with `@inherit`
- [Multi-File Organization](https://getpromptscript.dev/dev/guides/multi-file/index.md) — project-level file composition
