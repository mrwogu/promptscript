...
- [`prs hook`](https://getpromptscript.dev/dev/reference/cli/hook/index.md) — the hook handler invoked at runtime
- [Hooks Guide](https://getpromptscript.dev/dev/guides/hooks/index.md) - setup, generated configuration, and troubleshooting
