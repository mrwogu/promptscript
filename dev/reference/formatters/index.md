...
Commands MDC Format\](https://getpromptscript.dev/dev/reference/formatters/cursor/index.md) \[Antigravity Custom

`.agent/rules/project.md`

Workflows Activation Types\](https://getpromptscript.dev/dev/reference/formatters/antigravity/index.md) \[Factory AI Custom

`AGENTS.md`

Skills Agents Commands\](https://getpromptscript.dev/dev/reference/formatters/factory/index.md) \[Gemini CLI Custom

`GEMINI.md`

Skills Commands\](https://getpromptscript.dev/dev/reference/formatters/gemini/index.md) \[OpenCode Custom

`OPENCODE.md`

Skills Agents Commands\](https://getpromptscript.dev/dev/reference/formatters/opencode/index.md) \[Codex Native

`AGENTS.md + .codex/`

Skills Agents TOML\](https://getpromptscript.dev/dev/features/target-platforms/#rich-native-formatters) \[Grok Native

`AGENTS.md`

Skills Agents Commands\](https://getpromptscript.dev/dev/features/target-platforms/#rich-native-formatters)

## All Formatters

| Formatter                                                                                | Tier   | Output File                       | Skills | Agents | Local | Commands |
| ---------------------------------------------------------------------------------------- | ------ | --------------------------------- | ------ | ------ | ----- | -------- |
| [Antigravity](https://getpromptscript.dev/dev/reference/formatters/antigravity/index.md) | Custom | `.agent/rules/project.md`         | No     | No     | No    | Yes      |
| [Claude Code](https://getpromptscript.dev/dev/reference/formatters/claude/index.md)      | Custom | `CLAUDE.md`                       | Yes    | Yes    | Yes   | Yes      |
| [Cursor](https://getpromptscript.dev/dev/reference/formatters/cursor/index.md)           | Custom | `.cursor/rules/project.mdc`       | Yes    | Yes    | No    | Yes      |
