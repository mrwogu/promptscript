...
- [Language Reference - @agents](https://getpromptscript.dev/v1.8/reference/language/#agents)
- [Skills & Local Example](https://getpromptscript.dev/v1.8/examples/skills-and-local/index.md)
