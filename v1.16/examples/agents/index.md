...
- [Agent Platform - Agents](https://getpromptscript.dev/v1.16/features/agents/index.md)
- [Skills & Local Example](https://getpromptscript.dev/v1.16/examples/skills-and-local/index.md)
