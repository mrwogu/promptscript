...
## Using [@use](https://github.com/use "GitHub User: use") for Composition
...
### How [@use](https://github.com/use "GitHub User: use") Merges Content
...
See [Composition and Precedence](https://getpromptscript.dev/v1.16/reference/language/composition/index.md) for the normative matrix and resolved declaration-order examples.
...
1. Verify registry path in `promptscript.yaml`
1. Ensure `@meta.id` matches expected paths

## Next Steps

- [Local Skills](https://getpromptscript.dev/v1.16/guides/local-skills/index.md) - Install third-party skills with resource files
- [Inheritance Guide](https://getpromptscript.dev/v1.16/guides/inheritance/index.md) - Deep dive into inheritance patterns
- [Enterprise Setup](https://getpromptscript.dev/v1.16/guides/enterprise/index.md) - Organization-wide registries
- [Configuration Reference](https://getpromptscript.dev/v1.16/reference/config/index.md) - Full config options
