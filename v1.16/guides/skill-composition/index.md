...
- [Building Skills](https://getpromptscript.dev/v1.16/guides/building-skills/index.md) — skill basics, parameters, and resource files
- [Skill Contracts](https://getpromptscript.dev/v1.16/guides/skill-contracts/index.md) — define inputs and outputs for phases
- [Inheritance](https://getpromptscript.dev/v1.16/guides/inheritance/index.md) — single inheritance with `@inherit`
- [Multi-File Organization](https://getpromptscript.dev/v1.16/guides/multi-file/index.md) — project-level file composition
