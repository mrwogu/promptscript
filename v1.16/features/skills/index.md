...
- [Building Skills](https://getpromptscript.dev/v1.16/guides/building-skills/index.md)
- [Local Skills](https://getpromptscript.dev/v1.16/guides/local-skills/index.md)
- [Skill Composition](https://getpromptscript.dev/v1.16/guides/skill-composition/index.md)
- [Skill Contracts](https://getpromptscript.dev/v1.16/guides/skill-contracts/index.md)
- [Shared Resources](https://getpromptscript.dev/v1.16/guides/shared-resources/index.md)
