...
Both `@hooks` and `@workflows` use canonical object bodies. See [Block Shapes](https://getpromptscript.dev/v1.16/reference/block-shapes/index.md) for their shape diagnostics, merge behavior, and complete examples.
...
- [AI Tool Hooks](https://getpromptscript.dev/v1.16/guides/hooks/index.md)
- [CLI Reference](https://getpromptscript.dev/v1.16/reference/cli/index.md)
- [Configuration: Build Profiles](https://getpromptscript.dev/v1.16/reference/config/#builds)
- [Language Reference: `@hooks`](https://getpromptscript.dev/v1.16/reference/language/#hooks)
- [Language Reference: `@workflows`](https://getpromptscript.dev/v1.16/reference/language/#workflows)
