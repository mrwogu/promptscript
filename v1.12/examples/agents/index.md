...
- [Language Reference - @agents](https://getpromptscript.dev/v1.12/reference/language/#agents)
- [Skills & Local Example](https://getpromptscript.dev/v1.12/examples/skills-and-local/index.md)
