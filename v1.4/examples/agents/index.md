...
- [Language Reference - @agents](https://getpromptscript.dev/v1.4/reference/language/#agents)
- [Skills & Local Example](https://getpromptscript.dev/v1.4/examples/skills-and-local/index.md)
