...
Ready to switch? See the [Migration Guide](https://getpromptscript.dev/v1.20/guides/migration/index.md) to convert existing configs, or start fresh with the [Getting Started guide](https://getpromptscript.dev/v1.20/getting-started/index.md).

Evaluating for a team or organization? Also see:

- [Target Platform Matrix](https://getpromptscript.dev/v1.20/reference/formatters/index.md) - exact output paths per tool
- [CI/CD Integration](https://getpromptscript.dev/v1.20/guides/ci/index.md) - validation and drift detection in your pipeline
- [Enterprise Setup](https://getpromptscript.dev/v1.20/guides/enterprise/index.md) - registry, policies, and governance across repositories
