...
Formatter inputs follow the canonical and compatibility contracts in the [Block Shapes reference](https://getpromptscript.dev/v1.20/reference/block-shapes/index.md). That reference also identifies content whose output varies by target.
