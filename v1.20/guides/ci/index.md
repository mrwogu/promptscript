...
The block below shows the shape of a Docker-based pipeline, not valid syntax for any single CI system (`image:` and `steps:` keys are borrowed from different systems). Use it as a mental model only - concrete, runnable pipelines are in the [Docker Guide](https://getpromptscript.dev/v1.20/guides/docker/index.md).
...
See the [Docker Guide](https://getpromptscript.dev/v1.20/guides/docker/index.md) for complete examples including:
