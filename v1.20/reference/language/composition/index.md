...
See [Execution Order](https://getpromptscript.dev/v1.20/reference/language/execution-order/index.md) for operation timing and [Merge and Replacement](https://getpromptscript.dev/v1.20/reference/language/merge-and-replacement/index.md) for modification choices.
