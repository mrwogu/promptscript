...
PromptScript treats instructions, skills, agents, commands, MCP servers, hooks, workflows, and plugins as platform capabilities. See [Target Platforms](https://getpromptscript.dev/v1.20/features/target-platforms/index.md) for the platform-family model.
...
Skills Agents Commands Local\](https://getpromptscript.dev/v1.20/reference/formatters/claude/index.md) \[GitHub Copilot Custom

`.github/copilot-instructions.md`

Skills Prompts\](https://getpromptscript.dev/v1.20/reference/formatters/github/index.md) \[Cursor Custom

`.cursor/rules/project.mdc`

Commands MDC Format\](https://getpromptscript.dev/v1.20/reference/formatters/cursor/index.md) \[Antigravity Custom

`.agent/rules/project.md`

Workflows Activation Types\](https://getpromptscript.dev/v1.20/reference/formatters/antigravity/index.md) \[Factory AI Custom

`AGENTS.md`

Skills Agents Commands\](https://getpromptscript.dev/v1.20/reference/formatters/factory/index.md) \[Gemini CLI Custom

`GEMINI.md`

Skills Commands\](https://getpromptscript.dev/v1.20/reference/formatters/gemini/index.md) \[OpenCode Custom

`OPENCODE.md`

Skills Agents Commands\](https://getpromptscript.dev/v1.20/reference/formatters/opencode/index.md) \[Codex Native

`AGENTS.md + .codex/`

Skills Agents TOML\](https://getpromptscript.dev/v1.20/features/target-platforms/#rich-native-formatters) \[Grok Native

`AGENTS.md`

Skills Agents Commands\](https://getpromptscript.dev/v1.20/features/target-platforms/#rich-native-formatters)

## All Formatters

| Formatter                                                                                  | Tier   | Output File                       | Skills | Agents | Local | Commands |
| ------------------------------------------------------------------------------------------ | ------ | --------------------------------- | ------ | ------ | ----- | -------- |
| [Antigravity](https://getpromptscript.dev/v1.20/reference/formatters/antigravity/index.md) | Custom | `.agent/rules/project.md`         | No     | No     | No    | Yes      |
| [Claude Code](https://getpromptscript.dev/v1.20/reference/formatters/claude/index.md)      | Custom | `CLAUDE.md`                       | Yes    | Yes    | Yes   | Yes      |
| [Cursor](https://getpromptscript.dev/v1.20/reference/formatters/cursor/index.md)           | Custom | `.cursor/rules/project.mdc`       | Yes    | Yes    | No    | Yes      |
| [Factory AI](https://getpromptscript.dev/v1.20/reference/formatters/factory/index.md)      | Custom | `AGENTS.md`                       | Yes    | Yes    | No    | Yes      |
| [Gemini CLI](https://getpromptscript.dev/v1.20/reference/formatters/gemini/index.md)       | Custom | `GEMINI.md`                       | Yes    | No     | No    | Yes      |
| [GitHub Copilot](https://getpromptscript.dev/v1.20/reference/formatters/github/index.md)   | Custom | `.github/copilot-instructions.md` | Yes    | Yes    | No    | Yes      |
| [OpenCode](https://getpromptscript.dev/v1.20/reference/formatters/opencode/index.md)       | Custom | `OPENCODE.md`                     | Yes    | Yes    | No    | Yes      |
