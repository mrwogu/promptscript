...
(function () {
  ...
  var DEMO_CONFIGS = {
    ...
    'migrate-demo': {
      ...
      steps: [
        { type: 'command', text: 'prs migrate --static --dry-run' },
        { type: 'blank' },
        ...
        { type: 'blank' },
        { type: 'header', text: '  Planned changes:' },
        { type: 'file', text: '  [dry-run] create .promptscript/migrated/context.prs' },
        { type: 'file', text: '  [dry-run] create .promptscript/migrated/project.prs' },
        { type: 'file', text: '  [dry-run] update .promptscript/project.prs' },
        { type: 'blank' },
        { type: 'done', text: '  Preview complete. No files changed.' },
        { type: 'blank' },
        { type: 'command', text: 'prs migrate --static' },
        { type: 'blank' },
        { type: 'detect', text: '  Applying migration...', delay: DETECT_DELAY },
        { type: 'file', text: '  ✓ .promptscript/migrated/context.prs' },
        { type: 'file', text: '  ✓ .promptscript/migrated/project.prs' },
        { type: 'file', text: '  ✓ .promptscript/project.prs (updated)' },
        { type: 'blank' },
        { type: 'done', text: '  Migration complete. Existing instructions preserved.' },
      ],
    },
  };
