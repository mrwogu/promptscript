...
- [Local Skills Guide](https://getpromptscript.dev/v1.20/guides/local-skills/index.md) - Install third-party skills with resource files (CSV, scripts)
- [Language Reference: @skills](https://getpromptscript.dev/v1.20/reference/language/#skills)
- [Language Reference: @local](https://getpromptscript.dev/v1.20/reference/language/#local)
- [Formatters API: GitHub](https://getpromptscript.dev/v1.20/api-reference/formatters/src/classes/GitHubFormatter/index.md)
- [Formatters API: Claude](https://getpromptscript.dev/v1.20/api-reference/formatters/src/classes/ClaudeFormatter/index.md)
