...
- [Local Skills](https://getpromptscript.dev/v1.10/guides/local-skills/index.md) - Install third-party skills with resource files
- [Inheritance Guide](https://getpromptscript.dev/v1.10/guides/inheritance/index.md) - Deep dive into inheritance patterns
- [Enterprise Setup](https://getpromptscript.dev/v1.10/guides/enterprise/index.md) - Organization-wide registries
- [Configuration Reference](https://getpromptscript.dev/v1.10/reference/config/index.md) - Full config options
