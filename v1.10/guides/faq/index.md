...
PromptScript currently compiles to **37 AI coding agents**. See the full list in the [formatter architecture guide](https://getpromptscript.dev/v1.10/guides/formatter-architecture/index.md) or the [ROADMAP](https://github.com/mrwogu/promptscript/blob/main/ROADMAP.md).
...
See the [Getting Started guide](https://getpromptscript.dev/v1.10/getting-started/index.md) for details.
...
Sources can be local files (`./base`) or registry packages (`@company/standards`). See the [Inheritance guide](https://getpromptscript.dev/v1.10/guides/inheritance/index.md).
...
See the [Registry guide](https://getpromptscript.dev/v1.10/guides/registry/index.md) for full setup instructions.
...
See the [CI/CD guide](https://getpromptscript.dev/v1.10/guides/ci/index.md).
...
You used a directive that PromptScript doesn't recognize. Check the [Language Reference](https://getpromptscript.dev/v1.10/reference/language/index.md) for valid directives.
