...
- [Local Skills Guide](https://getpromptscript.dev/v1.10/guides/local-skills/index.md) - Install third-party skills with resource files (CSV, scripts)
- [Language Reference: @skills](https://getpromptscript.dev/v1.10/reference/language/#skills)
- [Language Reference: @local](https://getpromptscript.dev/v1.10/reference/language/#local)
- [Formatters API: GitHub](https://getpromptscript.dev/v1.10/api-reference/formatters/src/classes/GitHubFormatter/index.md)
- [Formatters API: Claude](https://getpromptscript.dev/v1.10/api-reference/formatters/src/classes/ClaudeFormatter/index.md)
