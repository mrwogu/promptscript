...
- [Language Reference - @agents](https://getpromptscript.dev/v1.10/reference/language/#agents)
- [Skills & Local Example](https://getpromptscript.dev/v1.10/examples/skills-and-local/index.md)
