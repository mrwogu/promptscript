...
See the [Examples guide](https://getpromptscript.dev/v1.10/guides/examples/index.md) for a full walkthrough.
...
See [Registry Aliases](https://getpromptscript.dev/v1.10/guides/registry/#registry-aliases) for alias configuration.
