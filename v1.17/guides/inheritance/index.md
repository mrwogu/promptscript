...
Use [Composition and Precedence](https://getpromptscript.dev/v1.17/reference/language/composition/index.md) as the normative source for conflict rules, declaration order, and resolved examples. This guide focuses on designing inheritance hierarchies rather than restating that matrix.
