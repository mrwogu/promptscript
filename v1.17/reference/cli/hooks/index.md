...
- [`prs hook`](https://getpromptscript.dev/v1.17/reference/cli/hook/index.md) — the hook handler invoked at runtime
- [Hooks Guide](https://getpromptscript.dev/v1.17/guides/hooks/index.md) - setup, generated configuration, and troubleshooting
