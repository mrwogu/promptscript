...
- [Language Reference - @agents](https://getpromptscript.dev/v1.11/reference/language/#agents)
- [Skills & Local Example](https://getpromptscript.dev/v1.11/examples/skills-and-local/index.md)
