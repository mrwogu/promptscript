...
1. **Use descriptive names** - `/commit`, `/review`, `/deploy` are clear
1. **Document prerequisites** - What tools or access does the skill need?
1. **Include examples** - Show expected input/output in the content
1. **Set appropriate flags** - Use `disableModelInvocation` for destructive operations

### Local Memory

1. **Never commit secrets** - Use environment variables instead
1. **Document temporary workarounds** - Include issue links
1. **Keep team contacts current** - Update when people change roles
1. **Add to .gitignore** - Ensure `CLAUDE.local.md` is not tracked

## See Also

- [Local Skills Guide](https://getpromptscript.dev/v1.11/guides/local-skills/index.md) - Install third-party skills with resource files (CSV, scripts)
- [Language Reference: @skills](https://getpromptscript.dev/v1.11/reference/language/#skills)
- [Language Reference: @local](https://getpromptscript.dev/v1.11/reference/language/#local)
- [Formatters API: GitHub](https://getpromptscript.dev/v1.11/api-reference/formatters/src/classes/GitHubFormatter/index.md)
- [Formatters API: Claude](https://getpromptscript.dev/v1.11/api-reference/formatters/src/classes/ClaudeFormatter/index.md)
