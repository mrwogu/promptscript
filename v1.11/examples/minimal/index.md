...
- Add more detailed [standards](https://getpromptscript.dev/v1.11/reference/language/#standards)
- Add [restrictions](https://getpromptscript.dev/v1.11/reference/language/#restrictions) for safety
- Consider [team setup](https://getpromptscript.dev/v1.11/examples/team-setup/index.md) for multiple projects
