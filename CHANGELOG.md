...
* **resolver:** stream Git tree verification ([#394](https://github.com/mrwogu/promptscript/issues/394)) ([81b46fa](https://github.com/mrwogu/promptscript/commit/81b46fa41cae1e9167da0db7a04d01b4b0bbeece))
...
* **cli:** migrate legacy Factory hooks ([#363](https://github.com/mrwogu/promptscript/issues/363)) ([d7f6333](https://github.com/mrwogu/promptscript/commit/d7f633390ec8c929df1f9586c8fcce74629bb7f2))
* **cli:** warn on legacy .factory/settings.json hooks ([492ed52](https://github.com/mrwogu/promptscript/commit/492ed52fe95c41011905978af6627d717111d0d0))
* **core:** add explicit override operations ([#368](https://github.com/mrwogu/promptscript/issues/368)) ([be41114](https://github.com/mrwogu/promptscript/commit/be411145c2d84c573e32b4cffa69df4bcab843f0)), closes [#349](https://github.com/mrwogu/promptscript/issues/349)
* **core:** add section header overrides ([#361](https://github.com/mrwogu/promptscript/issues/361)) ([73c5dea](https://github.com/mrwogu/promptscript/commit/73c5dea07856d17e326e01228479658cf85889b5))
* **core:** define canonical block shapes ([#367](https://github.com/mrwogu/promptscript/issues/367)) ([96bfff1](https://github.com/mrwogu/promptscript/commit/96bfff1a9a93bbd256cf8822e16e48f4613e4e81)), closes [#348](https://github.com/mrwogu/promptscript/issues/348)
* **core:** register the unquoted environment value feature ([dace46c](https://github.com/mrwogu/promptscript/commit/dace46c1f5877cd9d06ce6a99a8e56cf330e9f40))
* **core:** unify block syntax with canonical AST ([7d7b213](https://github.com/mrwogu/promptscript/commit/7d7b21344d70154f8ae51a645715527f08699eb2))
* **formatters:** add portable hook working directories ([95c23cc](https://github.com/mrwogu/promptscript/commit/95c23ccd45cbfd865c018b74ef08ce4d2eb3b779))
* **formatters:** add target-aware hook outputs ([b5e425e](https://github.com/mrwogu/promptscript/commit/b5e425e5be22c36cc84bffad2e2c0de3649dff34))
* **formatters:** add terminal command hook event ([#364](https://github.com/mrwogu/promptscript/issues/364)) ([a0f8a7d](https://github.com/mrwogu/promptscript/commit/a0f8a7db021fc427d0e155808b2aab2d4ea2d566))
* **formatters:** compile portable hook scripts ([0e7193b](https://github.com/mrwogu/promptscript/commit/0e7193bc73b5fc957c9949dd653ec6ee2c4de03e))
* **formatters:** complete Antigravity block coverage ([1ace68b](https://github.com/mrwogu/promptscript/commit/1ace68bff5fd88679133ce127c4d516a9bf4feed))
* **formatters:** support target hook executables ([#362](https://github.com/mrwogu/promptscript/issues/362)) ([a6349c7](https://github.com/mrwogu/promptscript/commit/a6349c7a780ce3262071bfd7a4d86a2dcb29901d))
* **parser:** accept SCP-style Git paths in imports ([e0562e8](https://github.com/mrwogu/promptscript/commit/e0562e8191f53079299e89cf7c18edcf6e22e73f))
* **parser:** accept unquoted environment variables as values ([02ac4dc](https://github.com/mrwogu/promptscript/commit/02ac4dc079e1a09c8ab1a0842dc4d9af6ffc8737))
* **parser:** highlight fenced code in the documentation lexer ([fcdfcfb](https://github.com/mrwogu/promptscript/commit/fcdfcfb7fff880708299d605ca5888c3341e3908))
* **playground:** highlight fenced code inside text blocks ([f179026](https://github.com/mrwogu/promptscript/commit/f17902685972dddb89383c0940faa5c73e5f6887))
* **playground:** refresh 1.16 examples ([#370](https://github.com/mrwogu/promptscript/issues/370)) ([5689d15](https://github.com/mrwogu/promptscript/commit/5689d15a0df9fadebf328e2990a536f040053c02))
* **resolver:** resolve SCP-style Git imports to a registry ([e656054](https://github.com/mrwogu/promptscript/commit/e6560542c9072bcf510efe630762d9ba5055895d))
* **vscode:** highlight fenced code inside text blocks ([750d955](https://github.com/mrwogu/promptscript/commit/750d955fdbe765dcca1a53b3036d7687feb282ca))


### Bug Fixes

* **browser-compiler:** contain hook script paths ([e33369d](https://github.com/mrwogu/promptscript/commit/e33369dd5ade525e9ff7a008996c878803fa30fe))
* **browser-compiler:** normalize virtual project roots ([b20eb59](https://github.com/mrwogu/promptscript/commit/b20eb598182c789896eb93d495d94e42948372d9))
* **ci:** configure TypeDoc for NodeNext ([#381](https://github.com/mrwogu/promptscript/issues/381)) ([b99a761](https://github.com/mrwogu/promptscript/commit/b99a7611d65206563fca9f65b33b082508fb7927))
* **ci:** isolate schema generator config ([#382](https://github.com/mrwogu/promptscript/issues/382)) ([c82958e](https://github.com/mrwogu/promptscript/commit/c82958ef0accdbe64dbd225746f8785f6b7a5100))
* **cli:** allow mergeable hook configs ([999cf6a](https://github.com/mrwogu/promptscript/commit/999cf6a113f587892baf826c4cc76351f8227778))
* **cli:** anchor generated-file marker detection ([8248ecf](https://github.com/mrwogu/promptscript/commit/8248ecf491cf2ae89ffe79b5695ccbd7b1ea1a55))
* **cli:** drop legacy Factory settings left empty by migration ([2695328](https://github.com/mrwogu/promptscript/commit/2695328ab4fc5ae3483e2776831b6420b19b4bff))
* **cli:** gate legacy settings hooks warning on missing hooks.json ([20115d8](https://github.com/mrwogu/promptscript/commit/20115d8d4024433ff0bec75287878e719223ce56))
* **cli:** harden hook migration and cleanup ([74060c6](https://github.com/mrwogu/promptscript/commit/74060c654a3befa17f6d80bc7753fc13f4d9f530))
* **cli:** harden TOML hook ownership parsing ([a24e3af](https://github.com/mrwogu/promptscript/commit/a24e3af96f7638fd3a24906f54de737138999623))
* **cli:** preflight ownership conflicts before writing outputs ([0aaf589](https://github.com/mrwogu/promptscript/commit/0aaf589e6eba85d807c25e37849a1a26938ed6b4))
* **cli:** prune Codex hooks written before 1.16 ([5d148b5](https://github.com/mrwogu/promptscript/commit/5d148b593eeb7ca66cdac70e03d1ff861a7be103))
* **cli:** prune managed hook directories emptied by cleanup ([a19fb54](https://github.com/mrwogu/promptscript/commit/a19fb54e78c99d3fbb5c25ab7438ca944ca11a9a))
* **cli:** report the legacy Factory settings removal ([d2df37c](https://github.com/mrwogu/promptscript/commit/d2df37c6bc55da61a7a6ceade5d47abf0d90a8bd))
* **cli:** report unreadable hook output files accurately ([c72bb0b](https://github.com/mrwogu/promptscript/commit/c72bb0be2c7903421cfe4bc6942afb46ebdde93a))
* **core:** interpolate override replacements ([7c16af9](https://github.com/mrwogu/promptscript/commit/7c16af96101cea409f65a6ca81a8a0cea55e840b))
* **core:** remove regex ReDoS and patch dependencies ([#379](https://github.com/mrwogu/promptscript/issues/379)) ([38022a0](https://github.com/mrwogu/promptscript/commit/38022a05aaf2f7cb59e8cfff60dbf4ffd6f7d679))
* **docker:** remove runtime npm vulnerabilities ([#380](https://github.com/mrwogu/promptscript/issues/380)) ([ae94044](https://github.com/mrwogu/promptscript/commit/ae94044de55100f21910e1d7be7873cec7d290cc))
* **formatters:** accept paths alias in named guards ([64f3d4b](https://github.com/mrwogu/promptscript/commit/64f3d4bc988f6c4eb70634d5a2dd0cf6d554fe45))
* **formatters:** align split standards heading shift to minimum level ([e2e894e](https://github.com/mrwogu/promptscript/commit/e2e894e226abc0a3b2faaa99dc876195d372a42c))
* **formatters:** clean stale Grok settings ([9c6a405](https://github.com/mrwogu/promptscript/commit/9c6a40599f59e634a7dc4aed035ec69008e67a1c))
* **formatters:** dedent free-form standards text in factory output ([9bf616f](https://github.com/mrwogu/promptscript/commit/9bf616fe1cfb28dd90b28edd3328351090c04670))
* **formatters:** emit command files for prompt shortcuts ([67fd0be](https://github.com/mrwogu/promptscript/commit/67fd0bef1eb79f66eb7c68e4b6ed0419795b7329))
* **formatters:** emit current Factory and GitHub hooks ([899b415](https://github.com/mrwogu/promptscript/commit/899b415f828a067bb5782c3145cb4b0c8f700acc))
* **formatters:** emit launchable MCP stdio config ([23991c0](https://github.com/mrwogu/promptscript/commit/23991c0a3b01276c8242fc723305953da1816cec))
* **formatters:** fail closed without project root ([#365](https://github.com/mrwogu/promptscript/issues/365)) ([86231a2](https://github.com/mrwogu/promptscript/commit/86231a2e1aecc564a094ea02bf57e02d1655234f))
* **formatters:** flatten Grok delegated outputs ([eba37c6](https://github.com/mrwogu/promptscript/commit/eba37c6202e84121bcebdd2f9f94e4745bf69cee))
* **formatters:** generate hook documentation ([4a0ab47](https://github.com/mrwogu/promptscript/commit/4a0ab47b107d7dc2df421e3ccef31b9aa93a56ad))
* **formatters:** keep authored identity in Cursor output ([20f99ee](https://github.com/mrwogu/promptscript/commit/20f99ee68318f19c00f3b82e9c7a7cde19ebdbb9))
* **formatters:** keep cursor hooks.json managed when hooks omitted ([24c4a42](https://github.com/mrwogu/promptscript/commit/24c4a42e83ca45d33af2f0fbbdc9d3d104c930b0))
* **formatters:** keep custom [@standards](https://github.com/standards) keys in claude and cursor ([f7659af](https://github.com/mrwogu/promptscript/commit/f7659af32cb913348e2a7fd43f7d0b3991435ed8))
* **formatters:** keep ownership marker on non-script PowerShell fallback ([e380a0f](https://github.com/mrwogu/promptscript/commit/e380a0fc3b5c0758216b15cc3755bab91d158bef))
* **formatters:** mark Zencoder path rules unsupported ([c5e78e9](https://github.com/mrwogu/promptscript/commit/c5e78e9773800f6de888e5919115c96894442f74))
* **formatters:** preserve free-form heading structure ([041683b](https://github.com/mrwogu/promptscript/commit/041683bcca012c228d5d7715c854e51c5e2f866c))
* **formatters:** render agents for Amp and Augment ([2ae80e0](https://github.com/mrwogu/promptscript/commit/2ae80e000f0c51c2fc0c45cc61b92414d2e42022))
* **formatters:** render authored context and documentation text ([6b853fa](https://github.com/mrwogu/promptscript/commit/6b853fad3191b2e3545b33e4ac0ffc3550da5676))
* **formatters:** render Claude rule files from array standards ([c51b795](https://github.com/mrwogu/promptscript/commit/c51b79515c21329dbd4fc8d0e42761108113aeeb))
* **formatters:** render context project and scalar monorepo ([08e66ed](https://github.com/mrwogu/promptscript/commit/08e66ed60c6b81b644b1dfdb61aa7869bf4cba45))
* **formatters:** render custom [@standards](https://github.com/standards) git/config/diagrams keys ([b9cd784](https://github.com/mrwogu/promptscript/commit/b9cd784fa821074e24f0ddd0bf707f60de396b03)), closes [#327](https://github.com/mrwogu/promptscript/issues/327)
* **formatters:** render free-form text [@standards](https://github.com/standards) in Factory output ([61334a2](https://github.com/mrwogu/promptscript/commit/61334a2fca026aa17a0d303c1fb570f15c169c2d))
* **formatters:** report PS4002 when cursor mode cannot emit [@hooks](https://github.com/hooks) ([cae11e2](https://github.com/mrwogu/promptscript/commit/cae11e2c4d6fb2ba0f9da3c38c78333f891d17af))
* **formatters:** skip hooks whose command filters to empty ([7529587](https://github.com/mrwogu/promptscript/commit/75295873c5520f77424e0158ce5cd571c884a8f1))
* **formatters:** stop rule and workflow files clobbering each other ([147403c](https://github.com/mrwogu/promptscript/commit/147403c2af2a8c82b34608c65a56f31000b05874))
* **parser:** accept primitive types in typed block fields ([d665df2](https://github.com/mrwogu/promptscript/commit/d665df272d353ad574d0a9b70f4ad62e38a3d272))
* **parser:** keep scoped import paths apart from their version ([2f7a15b](https://github.com/mrwogu/promptscript/commit/2f7a15b0d1014f1b6f099c4bc886ed7c36d80c79))
* **parser:** map tsx fences to a lexer every Pygments ships ([a1c283e](https://github.com/mrwogu/promptscript/commit/a1c283e40d7e1c98437bdec46ed3294d76623f82))
* **parser:** sync syntax highlighters with import paths ([4e93760](https://github.com/mrwogu/promptscript/commit/4e93760c1579ca6af4ae4d1053067563f05b6a5e))
* **playground:** keep the Monarch grammar compiling ([262795f](https://github.com/mrwogu/promptscript/commit/262795f5f4336c37b16b028aa5cb502c21708954))
* **validator:** check defaults on typed block fields ([761c019](https://github.com/mrwogu/promptscript/commit/761c019fec71e9a2d0185dfa0bb3c58b45fb625f))
* **validator:** drop redundant backslash prefix check in cwd guard ([1e62871](https://github.com/mrwogu/promptscript/commit/1e6287113600db0fb1edd98cdc6d8127cde9e802))
* **validator:** walk override replacement content ([2b1ac68](https://github.com/mrwogu/promptscript/commit/2b1ac68e1842a29c96d82b481dc007a17ea53d55))

## [1.15.0](https://github.com/mrwogu/promptscript/compare/v1.14.2...v1.15.0) (2026-07-27)
...
* **cli:** never rewrite output when only the marker timestamp differs ([e032586](https://github.com/mrwogu/promptscript/commit/e032586c5b8016d74a6d06d1e592a73f4db407fa))
* **resolver:** ignore PromptScript-generated files as sources ([4fe0dab](https://github.com/mrwogu/promptscript/commit/4fe0dab7e9f6bc3b1242e0a7b4c62a649ba781df))
...
* **cli:** update SKILL.md with features since v1.11.1 ([0387200](https://github.com/mrwogu/promptscript/commit/038720008f829f7270bcf76253dff87d90c33cd7))
* **formatters:** filter unsupported frontmatter fields in Factory skill output ([#270](https://github.com/mrwogu/promptscript/issues/270)) ([141e76e](https://github.com/mrwogu/promptscript/commit/141e76e35d4497a1382f71c87b07fa8a049c61cb))
