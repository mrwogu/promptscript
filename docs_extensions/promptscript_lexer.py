...
class PromptScriptLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(@)(identity|context|standards|restrictions|knowledge|shortcuts|commands|guards|params|skills|local|agents|workflows|hooks|mcpServers|plugins|prompts|examples)\b",
